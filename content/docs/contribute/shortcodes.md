...
title: "Shortcodes"  # This is the page title
---

# Shortcodes

The shortcodes can be used in your .md (markdown) documents to create special functionality. This is a complete list of the possible shortcodes on this website:
